 ...
 */
public class ReleasePatient extends javax.swing.JFrame implements ActionListener{

    public ReleasePatient() {
        super("Release Patient");
    ...
    public void actionPerformed(ActionEvent event) {
        if(event.getSource() == releaseButton){
            DB db = new DB();
            db.releaseIndoorPatient(Integer.parseInt(idField.getText()));
        }
